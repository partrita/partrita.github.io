...
리눅스를 노트북에 최적화 시키는 툴에 [TLP](http://linrunner.de/en/tlp/tlp.html)가 있습니다. TLP 는 리눅스 배포판과 하드웨어를 자동으로 인식해 노트북의 전원관리와 여러 트윅을 적용 시켜주기 때문에 아주 편리합니다. 다음과 같은 기능이 있습니다.
